...
sha256 = "f03fe4a7b1a060ca5100b6e71537bcfe88a998ef9f7a3a8c094e3005d7203276"
tool_flags = {
...
def post_install(self):
    ...
    # debian-specific; proper configs are in usr/share/X11/xorg.conf.d
    self.uninstall("etc/X11/xorg.conf.d")
